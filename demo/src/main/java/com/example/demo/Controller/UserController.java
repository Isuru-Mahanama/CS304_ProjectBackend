...
public class UserController {
    ...
    public Map<String, Object> getAllUserDetailsANDFreelancerDetails(@AuthenticationPrincipal UserDetails userDetails){
       ...
       // Optional<Client> client = clientService.getAllDetals(user.getUserID());
        ...
        response.put("Freelncer",freelancer.get());
    ...
    @GetMapping("/getalluserandclientDetais")
    public Map<String, Object> getAllUserDetailsANDClientDetails(@AuthenticationPrincipal UserDetails userDetails){
